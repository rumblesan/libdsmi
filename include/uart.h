 ...
 *
 *		has a timeout to help with implementation in DSMI library
 *		@param			length of time to wait before function times out
 *		@return			returns boolean true or false depending on success
 */
bool uart_init();
